...
import { UserPlus, Link2, Mail, Check, Copy } from "lucide-react";
...
export function InviteParticipantsDialog({ tripId, inviteToken, tripName }: Props) {
  ...
  const handleSendEmail = async () => {
    ...
    // Use mailto as fallback (no edge function needed for MVP)
